...
void handleOutputRedirection(std::vector<char *> &lineTokens)
{
  ...
  while(outputRedirection != -1)
  {
    ...
    lineTokens.erase(lineTokens.begin() + outputRedirection,
                     lineTokens.begin() + outputRedirection + 2);
...
void handleInputRedirection(std::vector<char *> &lineTokens)
{
  ...
  while(inputRedirection != -1)
  {
    ...
    lineTokens.erase(lineTokens.begin() + inputRedirection,
                     lineTokens.begin() + inputRedirection + 2);
